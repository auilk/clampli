...
function Toggle({fontSize = 1, padding = 1, firstOption = "option01", secondOption = "option02", vertical = false, fullWidth = false})
{
    ...
    return (
        <button
            ...
            onClick={() => SetOption(option === firstOption ? secondOption : firstOption)}
            style={{
        ...
        >
            <svg
                ...
                style={{
                    ...
                    transform: option === firstOption ? vertical ? "rotateZ(0deg) rotateY(0deg)" : "rotateZ(90deg) rotateY(0deg)"  : vertical ? "rotateZ(0deg) rotateY(-180deg)" : "rotateZ(90deg) rotateY(-180deg)",
                }}
            >
                <path
            ...
            >
                ...
                <span
                    ...
                    style={{
                        transform: option === firstOption ? vertical ? "rotateY(0deg)" : "rotateX(0deg)" : vertical ? "rotateY(180deg)" : "rotateX(180deg)",
                ...
                <span
                    className="absolute top-1/2 left-1/2 transition-transform duration-500 w-fit text-nowrap -translate-1/2 backface-hidden"
                    style={{
                        transform: option === secondOption ? vertical ? "rotateY(0deg)" : "rotateX(0deg)" : vertical ? "rotateY(-180deg)" : "rotateX(-180deg)",
                        transformOrigin: `center center ${-10 * fontSize}px` 
                    }}
                >
                    {secondOption}
